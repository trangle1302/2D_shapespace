...
def warp_image(pts_from, pts_to, img, midpoint=False, plot=True, save_dir=""):
    ...
    if midpoint:
        ...
        transform1 = TPSpline.warp_image(pts_from, midpoint, (0, 0, x_max, y_max), approximate_grid=4)
        transform2 = TPSpline.warp_image(midpoint, pts_to, (0, 0, x_max, y_max), approximate_grid=4)
        ...
        transform = TPSpline.warp_image(pts_from, pts_to, (0, 0, x_max, y_max), approximate_grid=4)
