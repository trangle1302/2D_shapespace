# Modified from CellTool software, Copyright 2007 Zachary Pincus under GPLv2

import cv2
import numpy as np

def warp_images(from_points, to_points, image, output_region, interpolation_order = 1, approximate_grid=2):
    ...
    return cv2.remap(image, transform[1].astype('float32'), transform[0].astype('float32'), cv2.INTER_LINEAR)
