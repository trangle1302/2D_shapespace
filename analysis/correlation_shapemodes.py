...
def main():    
    ...
    for PC in cells_assigned.keys():
        ...
        sc_stats = sc_stats.merge(df_[[PC, "ab_id", "cell_id"]], on=["ab_id","cell_id"])
    ...
    tmp=sc_stats[['cell_area', 'nu_area', 'nu_eccentricity', 'pseudotime',
       'MT_cell_mean', 'PC1', 'PC2', 'PC3', 'PC4', 'PC5', 'PC6']]
    ...
    keep_cols = ['cell_area', 'nu_area', 'nu_eccentricity', 'pseudotime', 'Protein_nu_mean', 'Protein_cytosol_mean',
       'MT_cell_mean', 'PC1', 'PC2', 'PC3', 'PC4', 'PC5', 'PC6']
